  ...
  render() {
    ...
    return (
      <div className="flex flex-row flex-auto shadow-md ml-1">
        <button
          className="flex-initial lg:hidden  center-items basis-16"
          ...
          <DynamicHeroIcon
            className={`${
              this.props.isSideBarOpen
                ? "rounded-full "
                : "!w-7 !h-7 rounded-md "
            }  p-1  hover-toggle transition ease-in-out duration-300`}
            icon={this.props.isSideBarOpen ? "MdArrowBackIosNew" : "HiMenu"}
          />
        </button>
