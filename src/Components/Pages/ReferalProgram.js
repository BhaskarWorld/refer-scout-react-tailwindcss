                        ...
                        <div className="grid grid-flow-row grid-cols-12 justify-between items-center h-full ">
                            <div className="h-full text-gray-500 text-base font-thin  col-span-12">
                                ...
                                <div className="relative">
                                    ...
                                    <label
                                        htmlFor={ProductName}
                                        className="absolute text-sm text-gray-500 font-medium duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-transparent peer-focus:bg-white px-2 peer-focus:px-2  peer-focus:text-blue-600 peer-focus:font-thin peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">
                                        {ProductName}
                                    </label>
                                    {ProductValue.Dropdown &&
                                        <label
                                            htmlFor={ProductName}
                                            data-dropdown-toggle={`dropdown-${ProductName}`}
    ...
    return (
        <div className="md:bg-gray-200 bg-white flex-grow flex flex-col p-0  md:px-8 lg:px-10 xl:px-20">
            <div className=" basis-12 bg-transparent center-items md:!justify-start ">
                <div className="text-gray-800 font-extrabold text-xl">Manage Rewards</div>
            </div>
                    ...
                    <div className="flex flex-col col-span-12 lg:col-span-10 xl:col-span-9 2xl:col-span-8 ">
                        <div className="basis-14  ">
                            <div className="grid grid-cols-2 h-full center-items">
                                <div className="text-gray-800 col-span-10 font-bold text-md">Enable Rewards Shop</div>
                        ...
                        <div className=" flex-grow basis-auto">
                            <div className="grid grid-cols-2 h-full center-items !items-start">
                                <div className="col-span-10">
                                    <div className="text-gray-800  font-bold text-md ">Coins Accumulation</div>
                                    <div className="text-gray-400  font-medium text-xs py-1 pr-2 md:4 lg:pr-6 xl:pr-8">
                                        Enabling rewards shop automatically enables Coins Accumulation.
                                        This allows employees to get Coins for every ScoutPoints they earn and
                                        they can redeem their coins for products in the Rewards Shop.
                                        Their Coin's balance will be visible in Employee's Rewards Shop.
                                        <div className="text-gray-500 font-bold italic text-xs pt-1 sm:pt-2  md:pt-3">1 ScoutPoint = 1 Coin</div>
                                    </div>
                                </div>
                ...
                <div className=" flex  flex-col lg:flex-row gap-4   flex-grow basis-11/12">
                    ...
                    <div className="basis-auto md:basis-3/5 xl:basis-7/12 2xl:basis-9/12 flex-shrink ">
                        <div className="center-items  lg:!justify-start ">
                            <div className="text-gray-700  font-bold text-medium mt-4">Shop Inventory</div>
                        </div>
                        {/* Cards */}
                    ...
                    <div className="basis-auto md:basis-2/5 xl:basis-5/12 2xl:basis-3/12 flex-shrink hidden sm:block  ">
                        <div className="  center-items  ">
                            <div className="text-gray-700  font-bold text-medium mt-4">Product Details</div>
                        </div>
